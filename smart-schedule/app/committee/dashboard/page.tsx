...
import { CoursesSearchDemo } from '../../../components/CoursesSearchDemo'

// charts
import { EnrollmentByCourse } from '../../../components/charts/EnrollmentByCourse'
import { UtilizationTrend } from '../../../components/charts/UtilizationTrend'
...
export default function CommitteeDashboard() {
  ...
  // sample chart data (fake rn; hook to API later)
  const enrollmentData = [
    { course: 'CS101', enrolled: 120 },
    { course: 'MATH220', enrolled: 85 },
    { course: 'PHY110', enrolled: 76 },
  ]

  const utilization = [
    { week: 'W1', utilizationPct: 62 },
    { week: 'W2', utilizationPct: 67 },
    { week: 'W3', utilizationPct: 72 },
    { week: 'W4', utilizationPct: 70 },
  ]

  return (
    <ProtectedRoute requiredRole="committee">
      <div className="min-h-screen bg-gray-50">
        <AppHeader title="Committee Dashboard" showBack={false} />
              ...
              {activeTab === 'overview' && (
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <EnrollmentByCourse data={enrollmentData} />
                    <UtilizationTrend data={utilization} />
                  </div>
