...
This section documents the exact packages required for the new features (Dashboards + Realtime Collaboration) and how to install them for both frontend and backend. Commands assume the repository structure in this project.

Frontend (Next.js)

Purpose: Charts rendering and realtime document sync.
...
Backend (Realtime WebSocket Server)

Purpose: Yjs synchronization layer over WebSocket.
# From project root
cd backend

# WebSocket + minimal HTTP server
npm install ws y-websocket express

Environment Variables (Frontend)

Purpose: Point the app to API and realtime servers.
...
Purpose: Start the Yjs WebSocket service.
# From project root
cd backend
